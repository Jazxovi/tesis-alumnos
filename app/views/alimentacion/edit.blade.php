...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            {{ Form::open(array('route' => ['alimentacion.update', $data->id], 'method' => 'put')) }}
                ...
                <div class="form-group">
                    ...
                    @if($data->ya_consumiste_alimento == "siempre")
                        <option value="siempre" selected>siempre</option>
                        <option value="casi siempre">casi siempre</option>
                        <option value="nunca">nunca</option>
                    @elseif($data->ya_consumiste_alimento == "casi siempre")
                        <option value="siempre">siempre</option>
                        <option value="casi siempre" selected>casi siempre</option>
                        <option value="nunca">nunca</option>
                    @elseif($data->ya_consumiste_alimento == "nunca")
                        <option value="siempre">siempre</option>
                        <option value="casi siempre">casi siempre</option>
